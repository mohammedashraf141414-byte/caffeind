              ...
              <div className="mx-auto max-w-md">
                <div className="text-center">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-crema/70">
                    Sign in to your account to view orders and save preferences.
                  </p>
                </div>
                ...
                <form className="mt-8 grid gap-5">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <label className="flex items-center gap-2">
                      ...
                      />
                      <span className="text-crema/70">Remember me</span>
                    </label>
                ...
                <div className="mt-8 text-center">
                  <p className="text-sm text-crema/70">
                    ...
                    <Link to="/signup" className="text-caramel transition hover:text-caramel/80">
                      Sign up
                    </Link>
                  </p>
                </div>
                ...
                <div className="mt-8 rounded-2xl border border-crema/10 bg-espresso-950/30 p-5">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-crema/70">
                    This is a UI demo—no real authentication. Sign in/out is simulated.
                  </p>
                </div>
              </div>
            </motion.div>
